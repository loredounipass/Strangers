...
io.on('connection', (socket) => {
    ...
    socket.on('start', (clientIdOrCb, cb) => {
        try {
            ...
            (0, lib_1.handelStart)(roomArr, socket, clientId, actualCb, io);
        }
        catch (error) {
    ...
    socket.on('disconnect', () => {
        ...
        (0, lib_1.removeFromWaitingQueue)(socket.id);
    ...
    socket.on('sdp:send', (data) => {
        var _a;
        try {
            if (!((_a = data === null || data === void 0 ? void 0 : data.sdp) === null || _a === void 0 ? void 0 : _a.type)) {
                socket.emit('error', { message: 'Invalid SDP data' });
                return;
            }
            const info = (0, lib_1.getType)(socket.id, roomArr);
            if (!info) {
    ...
    socket.on('ice:send', (data) => {
        try {
            if (!(data === null || data === void 0 ? void 0 : data.candidate) || typeof data.candidate !== 'object') {
